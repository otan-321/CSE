        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-2xl p-8 max-w-md w-full border border-gray-100 dark:border-gray-800">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#exams" onClick={() => setShowDisclaimer(false)} className="flex-1 px-6 py-3 bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-xl font-semibold text-center hover:from-blue-600 hover:to-purple-600 transition-all">
                I Understand, Continue
              </a>
              <button onClick={() => setShowDisclaimer(false)} className="flex-1 px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-all">
                Cancel
              </button>
            </div>
          </div>
