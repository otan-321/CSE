    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-950">
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">Privacy Policy - CSE Reviewer</h1>
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-200">
            <section>
              ...
              <p>CSE Reviewer is designed with your privacy as a top priority. We operate on a strict no-tracking, no-collection principle:</p>
            ...
            <section>
              ...
              <p>CSE Reviewer does not integrate with third-party analytics, advertising, or tracking services. We are a standalone educational tool with no external dependencies that could compromise your privacy.</p>
            </section>
            
            <section>
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">4. Changes to Privacy Policy</h2>
              <p>We may update this Privacy Policy to reflect changes in our practices. We will notify users of any material changes by updating the "Last Updated" date at the top of this policy. Continued use of CSE Reviewer constitutes acceptance of the updated policy.</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 p-4 bg-blue-50 dark:bg-gray-900 rounded-lg">
                ...
                <strong>Subject:</strong> Privacy Policy Inquiry - CSE Reviewer
              </p>
            ...
            <section>
              ...
              <p>As a user of CSE Reviewer, you have the right to:</p>
              <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 bg-blue-50 dark:bg-gray-900 p-6 rounded-lg">
            ...
            <p className="text-gray-700 dark:text-gray-200">
              CSE Reviewer is built on the principle that your study data belongs to you. 
